                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center space-x-4 pt-4">
                            <div className="flex -space-x-3">
                                {[1, 2, 3, 4].map(i => (
                                    <div key={i} className="w-10 h-10 rounded-xl border-2 border-black bg-white/10 flex items-center justify-center text-xs font-bold text-white/40">+{i}k</div>
                                ))}
                            </div>
                            <span className="text-xs font-bold text-white/50">Active Participants</span>
                        </div>
                    </div>

                    <div className="flex items-center space-x-8 text-xs font-medium text-white/40">
                        <div className="flex items-center space-x-2"><ShieldCheck size={16} /> <span>Secure Enrollment</span></div>
                        <div className="flex items-center space-x-2"><Zap size={16} /> <span>AI Matching</span></div>
                    </div>
                </div>
                ...
                <div className="bg-black/40 backdrop-blur-3xl p-12 lg:p-20 flex flex-col justify-center">
                    <div className="max-w-md mx-auto w-full space-y-10">
                        <div>
                            ...
                            <p className="text-white/50 text-sm">Join the platform to start building your team</p>
                        </div>
                        ...
                        <form className="space-y-6" onSubmit={handleSignup}>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <label className="text-xs text-white/50">I agree to the Terms of Service</label>
                            </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-xs text-white/40 uppercase"><span className="bg-[#0a0a0a] px-4">Or sign up with</span></div>
                        </div>
        ...
        <div className="space-y-1.5">
            ...
            <div className={cn(
                ...
                <input
                    ...
                    onFocus={onFocus}
                    onBlur={onBlur}
                    className="w-full bg-transparent p-4 pl-12 text-sm text-white placeholder:text-white/10 focus:outline-none"
                />
            </div>
        </div>
    );
